...
| **Total** | **≈63%** | **100** | **63.15 weighted points credited** | **39 open tasks / 19 active outcomes** | **36.85** |
...
**39 open task files own the remaining work across 19 active outcomes; 14 tasks are DONE.**
