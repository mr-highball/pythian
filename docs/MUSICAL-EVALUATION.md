...
cost are owned by [accepted native execution](TODO/DONE/NS-3_validation_02.md),
with the selected Pascal scope qualified separately from these small studies.
Experimental budgets are fixed stop conditions, not
