# NS-3_parts_02 — Learn simultaneous notes and part ownership

[Task index](README.md) · [Task flow](../TASKFLOW.MD) · [North star](../MILESTONES.md#ns-3)

**Description:**

Implement supported polyphonic note/event attribution and stable musical role identities using the stem/mix packet and trusted note primitives.
